  ...
  $("#login").click(function () {
    $.ajax({
      ...
      success: function (data) {
        window.location = "http://127.0.0.1:5500/teampage.html";
      },
      error: function () {
        if ($("#input_email").val() != "") {
          $("#form-messages").show(),
...
$(document).ready(function () {
  $("#nextpage").click(function () {
    debugger;
    window.location = "http://127.0.0.1:5500/teampage2.html";
    debugger;
  });
});
$(document).ready(function () {
...
/* jquery function that takes me back to teampage when clicked */
